...
class Api_Bca{
	...
	protected $settings = array(
		...
		'account_number' => '0613005827', // Fill With Your Account Number. 0201245680 is Sandbox Account
		'channelid' => '95051', //Channel Identification Number (Ex: 95051 for KlikBCA Bisnis)
		'credentialid' => 'h2hauto008' //Your Channel Identity (ex: Your KlikBCA Bisnis CorporateID)
	...
	public function getTransfer($account_number, $decode, $norek, $jumlah, $transfer_req_id, $berita_transfer, $apikey, $referenceid){
	...
	public function getDomTransfer($source_account, $decode, $norek, $jumlah, $transfer_req_id, $pemilik_rekening, $kode_bank, $berita_transfer, $apikey, $referenceid){
		//$apikey = $this->settings['api_key'];
		$secretkey = $this->settings['api_secret'];
		$main_url = $this->settings['main_url'];
		$corporate_id = $this->settings['corporate_id'];
		...
		$var = array(
		        ...
		        'Remark1' => strtolower(str_replace(' ', '', 'MRI Transfer')),
		        'Remark2' => strtolower(str_replace(' ', '', $berita_transfer)),
		        'SourceAccountNumber' => str_replace(' ', '', $source_account),// ex 0201245680
