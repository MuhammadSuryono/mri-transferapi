      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Laporan Transfer</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="form-group">
              ...
              <form action="<?php echo base_url('transfer/laporantransfer') ?>" method="get">
                ...
                <select name="kettrf">
                  ...
                  <?php
                  foreach ($kettrf as $data) :
                  ?>
                    <option value="<?php echo $data['ket_transfer'] ?>"><?php echo $data['ket_transfer'] ?></option>
                ...
                <select name="trftype">
                  <option value="">Pilih</option>
                  <option value="1">Transfer Schedule</option>
                  <option value="2">Transfer Manual</option>
                  <option value="3">Transfer Auto</option>
                </select>
          ...
          <div class="callout callout-info">
            ...
            $i = 1;
            $total = 0;
            foreach ($gettrflap as $data) {
              $total += $data->jumlah;
            }

            ?>
            <h5>Total Pembayaran : <?php echo 'Rp. ' . number_format($total, 0, '', ','); ?>
            </h5>
          </div>
          <div class="card-body">
            <form action="<?php echo base_url('transfer/exporttransfer') ?>" method="get">
