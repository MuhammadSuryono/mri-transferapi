...
class Transfer extends CI_Controller{
	...
	public function laporantransfer()
	  {
	    $keyword1 = htmlspecialchars($this->input->get('kettrf', true));
	    $keyword3 = $this->input->get('start_date');
	    $keyword4 = $this->input->get('end_date');
	    $keyword5 = htmlspecialchars($this->input->get('trftype', true));
	    $data['kettrf'] = $this->Transfer_model->getkettrf();
		$data['gettrflap']=$this->Transfer_model->gettrflap($keyword1, $keyword3, $keyword4, $keyword5);
		$this->load->view('template/header');
		$this->load->view('template/sidebar');
