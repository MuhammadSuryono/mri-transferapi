	  	...
	  	if (isset($_GET['start_date']) AND isset($_GET['end_date']))
			{
			   	...
			   	{
			       	$bagianWhere .= "waktu_request >= '$start_date' AND waktu_request <= '$end_date'";
			   	}
			}

		if (isset($_GET['kettrf']))
			{
			   	$kettrf = $_GET['kettrf'];
			   	if (empty($kettrf))
			   	{
			   		...
			   		$bagianWhere .= " AND ket_transfer = '$kettrf'";
			   	}
			}

		if (isset($_GET['trftype']))
			{
			   	...
			   	if (empty($trftype))
			   	{
			   		...
			   		$bagianWhere .= " AND transfer_type = '$trftype'";
			   	}
			}
